<div class="navigation navbar justify-content-center py-xl-4 py-md-3 py-0 px-3">
            ...
            <a href="{{ route('home') }}" title="Postman" class="brand">
            ...
            <div class="nav flex-md-column nav-pills flex-grow-1" role="tablist" aria-orientation="vertical">
                <a class="mb-xl-3 mb-md-2 nav-link" data-toggle="pill" href="#nav-tab-user" role="tab">
                    <img src="/web/images/user.png" class="avatar sm rounded-circle" alt="user avatar">
                </a>
                <a class="mb-xl-3 mb-md-2 nav-link active" data-toggle="pill" href="#nav-tab-chat" role="tab">
                    <i class="fa fa-comments" aria-hidden="true"></i>
                </a>
                <a class="mb-xl-3 mb-md-2 nav-link" data-toggle="pill" href="#nav-tab-phone" role="tab">
                    <i class="fa fa-phone" aria-hidden="true"></i>
                </a>
                <a class="mb-xl-3 mb-md-2 nav-link" data-toggle="pill" href="#nav-tab-contact" role="tab">
                    <i class="fa fa-user-circle" aria-hidden="true"></i>
                </a>
                <a class="mb-xl-3 mb-md-2 nav-link d-none d-sm-block" data-toggle="pill" href="#nav-tab-pages" role="tab">
            ...
            <div class="nav flex-md-column nav-pills flex-grow-2" role="tablist" aria-orientation="vertical">
                ...
                <a class="mt-xl-3 mt-md-2 nav-link d-none d-sm-block" href="javascript:;" role="tab">
